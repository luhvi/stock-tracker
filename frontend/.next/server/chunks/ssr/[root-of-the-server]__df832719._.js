...
"[project]/store/page.store.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/store/profileDropdown.store.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/store/loggedIn.store.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const LinkELement = ({ title, page, setPage })=>{
...
;
;
const ProfileDropdownElement = ({ title, Icon, setPage, setIsProfileDropdownOpen, setIsLoggedIn })=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$page$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/page.store.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$profileDropdown$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/profileDropdown.store.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$loggedIn$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/store/loggedIn.store.ts [app-ssr] (ecmascript)");
...
;
const Header = ()=>{
    const page = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$page$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePageStore"])((state)=>state.page);
    const setPage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$page$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePageStore"])((state)=>state.setPage);
    const isProfileDropdownOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$profileDropdown$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProfileDropdownStore"])((state)=>state.isProfileDropdownOpen);
    const toggleProfileDropdown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$profileDropdown$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProfileDropdownStore"])((state)=>state.toggleProfileDropdown);
    const setIsProfileDropdownOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$profileDropdown$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useProfileDropdownStore"])((state)=>state.setIsProfileDropdownOpen);
    const isLoggedIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$loggedIn$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLoggedInStore"])((state)=>state.isLoggedIn);
    const setIsLoggedIn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$loggedIn$2e$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useLoggedInStore"])((state)=>state.setIsLoggedIn);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df832719._.js.map