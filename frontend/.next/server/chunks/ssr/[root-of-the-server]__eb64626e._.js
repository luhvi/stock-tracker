...
"[project]/components/ui/graph.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Graph = ()=>{
    ...
    const [hists, setHists] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])({});
    const fetchTickerHist = async ()=>{
        try {
            const responses = await Promise.all(tickers.map((ticker)=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/hist/${ticker}`)));
            const next = {};
    ...
    const fetchTickerPrice = async ()=>{
        try {
            const responses = await Promise.all(tickers.map((ticker)=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/price/${ticker}`)));
            const next = {};
            tickers.forEach((ticker, index)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb64626e._.js.map