...
const Header = ()=>{
    ...
    const isProfileDropdownOpen = useProfileDropdownStore((state)=>state.isProfileDropdownOpen);
    const toggleProfileDropdown = useProfileDropdownStore((state)=>state.toggleProfileDropdown);
    const setIsProfileDropdownOpen = useProfileDropdownStore((state)=>state.setIsProfileDropdownOpen);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__410afc4e._.js.map